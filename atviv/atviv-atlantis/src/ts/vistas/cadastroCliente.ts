...
export default class CadastroCliente {
    ...
    public associarEventos(): void {
        ...
        const form = document.getElementById('form-cadastro-cliente') as HTMLFormElement;
        if (form) {
            form.addEventListener('submit', (e) => this.cadastrar(e));
        }
    }

    private cadastrar(evento: Event): void {
        evento.preventDefault();

        const nome = (document.getElementById('nome') as HTMLInputElement).value;
        const nomeSocial = (document.getElementById('nomeSocial') as HTMLInputElement).value;
        const dataNascimentoStr = (document.getElementById('dataNascimento') as HTMLInputElement).value;
        ...
        const tipoDocStr = (document.getElementById('tipoDocumento') as HTMLSelectElement).value;
        const numDoc = (document.getElementById('numeroDocumento') as HTMLInputElement).value;
        const dataExpStr = (document.getElementById('dataExpedicao') as HTMLInputElement).value;
        ...
        let tipoDocEnum: TipoDocumento;
        if (tipoDocStr === 'CPF') tipoDocEnum = TipoDocumento.CPF;
        else if (tipoDocStr === 'RG') tipoDocEnum = TipoDocumento.RG;
        else tipoDocEnum = TipoDocumento.Passaporte;
