...
export default class App {
    private elementoPrincipal: HTMLElement;

    constructor() {
        this.elementoPrincipal = document.getElementById('app') as HTMLElement;
        GeradorDados.gerar();
        this.inicializar();
    }
    ...
    private renderizarMenuPrincipal(): void {
    ...
    private associarEventosMenu(): void {
