...
// Criação e atribuição do Endereço ao Titular
...
// Criação e atribuição de Telefones ao Titular
...
cliente.telefones.forEach(t => {
    dependente.telefones.push(t.clonar() as Telefone)
})
